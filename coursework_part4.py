...
for x in ProgressArr:
    myfile.writelines('Progress :- '+str(x)+"\n")

for x in module_trailerArr:
    myfile.writelines('Progress (module trailer) :- '+str(x)+"\n")
                                                                            
for x in module_retrieverArr:
    myfile.writelines('Module retriever :- '+str(x)+"\n")
            
for x in ExcludeArr:
    myfile.writelines('Exclude :- '+str(x)+"\n")
